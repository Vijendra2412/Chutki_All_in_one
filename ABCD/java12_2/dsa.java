...
// ln(" enter ur Armstrong number btwn 1 and 1000:- ");
// =1;num<=1000;num++){
// um;
// 
// gth() ; //count the digit
...
// 
// 
// rintln(age + "  " + name + " "+ Address);
// 
// id main(String[] args) {
// = new ghi(40, "vijay", "noida");
// 
// 
...
// ic static void ain(String[] args) {
// ghi obj = new ghi();
// }
// }
//     nm obj;
...
//             int n = arr.length;
//             for(int i = 0; i < n-1; i++) {  // Fixed: changed j++ to i++
//                 int minIndex = i;
//                 for(int j = i+1; j < n; j++) {
...
//             System.out.println("\nArray after sorting:");  // Added "Array" for clarity
//             for(int i : arr) {
//                 System.out.print(i + " ");
//             }
//         }
...
//            // because single element is already sorted
//            for(int i = 1; i < n; i++) {
//                // Store current element as key to insert in right position
//                int key = arr[i];
               
//                // j points to index just before i
//                int j = i - 1;
...
//                while(j >= 0 && arr[j] > key) {
//                    // Shift larger element one position ahead
//                    arr[j + 1] = arr[j];
...
//                // j+1 because j was decremented in while loop
//                arr[j + 1] = key;
               
//                /* After each iteration, all elements from index 0 to i
//                   are sorted. For example:
//                   Initial array: [3, 4, 2, 5, 1, 3, 5]
//                   i=1: [3, 4, 2, 5, 1, 3, 5] // 3,4 sorted
//                   i=2: [2, 3, 4, 5, 1, 3, 5] // 2,3,4 sorted
//                   i=3: [2, 3, 4, 5, 1, 3, 5] // 2,3,4,5 sorted
//                   i=4: [1, 2, 3, 4, 5, 3, 5] // 1,2,3,4,5 sorted
//                   and so on... */
//            }
//        }
    ...
    public static void quicksort(int[] arr, int low, int high) {
        ...
        if(low < high) {
            /* Example: arr = [3,4,2,5,1,3,5], low = 0, high = 6
               ...
               Now array is divided into [2,1] and [4,5,3,5]
            */
